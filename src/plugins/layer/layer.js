        ...
        if (!i("#" + t.id)[0]) {
            switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift && (t.anim = t.shift), 6 == r.ie && (t.fixed = !1), t.type) {
                case 0:
                    ...
                    break;
                case 2:
                    //modified by wangzh 2018/04/28 自定义弹窗iframe ID
                    var layer_iframe_Id = t.id != "" && t.id != undefined ? t.id : s[4] + a;
                    var l = t.content = f ? t.content : [t.content || "http://layer.layui.com", "auto"];
                    t.content = '<iframe scrolling="' + (t.content[1] || "auto") + '" allowtransparency="true" id="' + layer_iframe_Id + '" name="' + layer_iframe_Id + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + t.content[0] + '"></iframe>';
                    break;
                case 3:
